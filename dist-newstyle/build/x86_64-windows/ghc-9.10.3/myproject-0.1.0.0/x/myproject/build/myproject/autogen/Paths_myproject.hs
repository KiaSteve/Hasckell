...
-- at runtime using the environment variable myproject_bindir.
...
-- environment variable myproject_libdir.
...
-- using the environment variable myproject_dynlibdir.
...
-- runtime using the environment variable myproject_datadir.
...
-- using the environment variable myproject_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.10.3-b42a\\myproject-0.1.0.0-inplace-myproject"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.10.3-b42a"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.10.3-b42a\\myproject-0.1.0.0"
libexecdir = "C:\\cabal\\myproject-0.1.0.0-inplace-myproject\\x86_64-windows-ghc-9.10.3-b42a\\myproject-0.1.0.0"
